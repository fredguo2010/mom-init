<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="产线名" prop="name">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['masterdata:productionline:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['masterdata:productionline:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['masterdata:productionline:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['masterdata:productionline:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="productionlineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="产线名" align="center" prop="name" />
      <el-table-column label="描述" align="center" prop="description" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="area_id" align="center" prop="areaId" />
      ...
      <el-table-column label="修改人" align="center" prop="lastModifiedBy" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="产线名" prop="name">
          <el-input v-model="form.name" placeholder="请输入产线名" />
        </el-form-item>
...
<script>
import { listProductionline, getProductionline, delProductionline, addProductionline, updateProductionline } from "@/api/masterdata/productionline";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('masterdata/productionline/export', {
        ...this.queryParams
