<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="工厂编号" prop="siteNumber">
        <el-input
          v-model="queryParams.siteNumber"
          placeholder="请输入工厂编号"
          clearable
      ...
      <el-form-item label="市区" prop="timeZone">
        <el-input
      ...
      <el-form-item label="最后修改日期" prop="lastModifiedDate">
        <el-date-picker clearable
          v-model="queryParams.lastModifiedDate"
          type="date"
          value-format="yyyy-MM-dd"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['masterdata:site:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['masterdata:site:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['masterdata:site:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['masterdata:site:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="siteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="工厂编号" align="center" prop="siteNumber" />
      <el-table-column label="工厂名" align="center" prop="name" />
      <el-table-column label="国家" align="center" prop="country" />
      <el-table-column label="省" align="center" prop="province" />
      <el-table-column label="市" align="center" prop="city" />
      <el-table-column label="地址" align="center" prop="address" />
      <el-table-column label="邮编" align="center" prop="postCode" />
      <el-table-column label="电话号码" align="center" prop="telNumber" />
      <el-table-column label="传真号" align="center" prop="faxNumber" />
      <el-table-column label="状态" align="center" prop="state" />
      <el-table-column label="描述" align="center" prop="description" />
      <el-table-column label="市区" align="center" prop="timeZone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="工厂编号" prop="siteNumber">
          <el-input v-model="form.siteNumber" placeholder="请输入工厂编号" />
        </el-form-item>
        <el-form-item label="工厂名" prop="name">
          <el-input v-model="form.name" placeholder="请输入工厂名" />
        </el-form-item>
        <el-form-item label="国家" prop="country">
        ...
        <el-form-item label="市区" prop="timeZone">
          <el-input v-model="form.timeZone" placeholder="请输入市区" />
        </el-form-item>
...
<script>
import { listSite, getSite, delSite, addSite, updateSite } from "@/api/masterdata/site";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除工厂编号为"' + ids + '"的数据项？').then(function() {
        return delSite(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('masterdata/site/export', {
        ...this.queryParams
